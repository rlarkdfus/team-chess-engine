...
public class TimeConfigurationUI extends GridPane implements UIInterface {
    ...
    public void createUI() {
        ...
        this.add(viewUtility.makeSlider("minutes", 0, 20, 10, e -> controller.setInitialTime(e)), 1, 2);
        this.add(viewUtility.makeLabel("increment_label"), 0, 3);
        this.add(viewUtility.makeSlider("increment", 0, 20, 10, e -> controller.setIncrement(e)), 1, 3);
    }
}
