...
/**
 * @authors purpose - the purpose of the endconditionrunner is to keep track of all the end conditions, loop through
...
public class EndConditionRunner {
  private final List<EndConditionInterface> endConditions;
