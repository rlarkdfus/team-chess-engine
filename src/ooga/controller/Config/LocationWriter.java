 ...
 * players to a csv file containing initial states so that the user can play a new game at a later
 * time with pieces at the locations of the last game. Assumptions: The file path passed to save
 * file will be a correct path to the user's local computer Dependencies: PlayerInterface API, and
 * the ability to get all the pieces from this.
 *
 * @author Luis Pereda
 */
public class LocationWriter {
   ...
   * initialize a new game. This uses the PlayerInterface API to get all the pieces from the
   * players.
   *
